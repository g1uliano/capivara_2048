...
GlassPanel(
  ...
  child: Column(
    children: [
      ...
      Text('Corpo do texto', style: GoogleFonts.fredoka(fontSize: 16, height: 1.5, color: Colors.white)),
    ],
  ),
)
```
...
Sempre confirmar em qual fase estamos antes de implementar. Fase atual: **Fase 6 (v1.9.40) — Polimento, l10n, acessibilidade, lançamento**.
...
| 4.4 ✅    | Tutorial wizard interativo (TutorialScreen 4 telas, TutorialSandboxPage 3 passos, TutorialItemsPage demo interativa bomba/desfazer, TutorialController) |
