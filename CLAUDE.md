...
Sempre confirmar em qual fase estamos antes de implementar. Fase atual: **Fase 2.13 concluída (v1.2.0) — próximo: Fase 3**. O áudio foi reposicionado para a **Fase 5** (antes do lançamento) — o jogo é desenvolvido sem áudio até lá.
