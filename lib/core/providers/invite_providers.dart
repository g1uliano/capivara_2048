...
class PendingInviteRefNotifier extends Notifier<String?> {
  @override
  String? build() => null;
...
final pendingInviteRefProvider =
    NotifierProvider<PendingInviteRefNotifier, String?>(
  PendingInviteRefNotifier.new,
);
