...
> Nomenclatura: a funcionalidade se chama **"Tutorial"**. Verbo das regras na UI
> e na prosa: **unir/juntar num mesmo bicho** — nunca "fundir".
...
consegue demonstrar nem "tudo desliza junto" nem "só os iguais se unem num só",
...
do tutorial, mover o tabuleiro, unir dois iguais num mesmo bicho e entender as
três ferramentas — sem depender de um adulto explicando.
...
- Verbo das regras: **unir/juntar num mesmo bicho** — nunca "fundir".
